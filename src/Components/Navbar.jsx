        ...
        <nav className="nav container items-center  dark:bg-slate-100 dark:text-black">
          <div className="nav__data items-center">
             <div className="logo-price-container items-center">
              <NavLink to="/" className="nav__logo  items-center">
                {themeMode === 'dark' ? <img src={blockLogo} alt="Logo1" /> 
                : 
                <img src={logo} alt="Logo" className='' />}
              </NavLink>
              <div className="md:ml-[52px] lg:ml-[65px] blocxL items-center">
                $0.0505
              </div>
            </div>
          ...
          <div className={`nav__menu ${showMenu ? 'show-menu' : ''}`} id="nav-menu">
            <ul className="nav__list dark:text-black">
              ...
              <NavLink to="/masternode" activeClassName="active" className="nav__link whitespace-nowrap">Masternodes</NavLink>
              <li>
                <NavLink to="/networkpeers" activeClassName="active" className="nav__link whitespace-nowrap">Network Peers</NavLink>
              </li>
              <li>
                <NavLink to="/transaction" activeClassName="active" className="nav__link whitespace-nowrap">Transactions</NavLink>
              </li>
              <li>
                <NavLink to="/coinholders" activeClassName="active" className="nav__link whitespace-nowrap">Coin Holders</NavLink>
              </li>
              <li>
                <NavLink to="/claimaddress" activeClassName="active" className="nav__link whitespace-nowrap">Claim Address</NavLink>
              </li>
              <li>
                <NavLink to="/orphendBlock" activeClassName="active" className="nav__link whitespace-nowrap">Orphaned Blocks</NavLink>
              </li>
            </ul>
          </div>
        </nav>
